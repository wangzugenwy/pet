	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
					// 创建带有拖动的html
					html += '<form id="uploadForm" action="../userServlet?action=doPresentimgtwo" method="post" enctype="multipart/form-data">';
	            	...
	            	html += '						<input id="fileImage" type="file" size="30" name="file" >';
	            	html += '					</div>';
	            	html += '				</div>';
					...
					html += '			<input type="submit" id="fileSubmit" class="upload_submit_btn">确认上传文件';
					html += '		</div>';
		            ...
		            html += '				<div id="status_info" class="info">选中0张文件，共0B。</div>';
		            html += '				<div class="btns">';
		            html += '					<input id="fileImage" type="file" size="30" name="file" '+multiple+'>';
		            html += '					<div class="webuploader_pick">选择文件</div>';
		            html += '					<input type = "submit" class="upload_btn">开始上传</div>';
		            html += '				</div>';
		            html += '			</div>';
					...
					html += '		</div>';
					html += '		<div class="upload_submit">';
					html += '			<input type="submit" id="fileSubmit" class="upload_submit_btn">确认上传文件</button>';
					html += '		</div>';
					html += '		<div id="uploadInf" class="upload_inf"></div>';
					html += '	</div>';
					html += '</form>';
